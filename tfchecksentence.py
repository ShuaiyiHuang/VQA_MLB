...
def input_pipeline(data_prefix='../myMLB/data/shapes/train.tiny',max_doc_length=7,use_glove=False):
    ...
    print data_prefix,'size3:',size3,' ',size3/length,'size4:',size4,' ',size4/length,'size5:',size5,' ',size5/length,'size unknown:',sizeunknown,sizeunknown/length
...
if __name__=="__main__":
    ...
    train_prefix='../../nmn2/data/shapes_1x/train.large'
    val_prefix='../../nmn2/data/shapes_1x/val'
    test_prefix='../../nmn2/data/shapes_1x/test'

    print 'train_prefix:',train_prefix

    max_doclength=7

    shapes_data=get_dataset(train_prefix,val_prefix,test_prefix,max_document_length=max_doclength)
