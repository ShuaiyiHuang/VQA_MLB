...
#tensorflow learn.preprocessing.VocabularyProcessor.fit
#usage reference https://ireneli.eu/2017/01/17/tensorflow-07-word-embeddings-2-loading-pre-trained-vectors/
...
tfembedding.embedding_prepare3(tfargs.max_doc_length,tfargs.use_glove,tfargs.is_emdb_matrix_trainable)
...
testarr3=['canel','canem','caner']
res3=np.array(list(tfargs.Pretrain.transform(testarr3)))
print res3.shape,res3

vocab=tfargs.Pretrain.vocabulary_
print tfargs.Pretrain.vocabulary_
for i in range(220):
    print i,vocab[i]
